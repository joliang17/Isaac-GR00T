...
#SBATCH --job-name=rc_base_env_eval
#SBATCH --output=slurm_output/rc_base_env_eval.log
#SBATCH --error=slurm_output/rc_base_env_eval.log
...
CKPT="/fs/nexus-projects/wilddiffusion/vla/GR00T/checkpoint/robocerebra_study_table_baseline_no_skill/checkpoint-30000"
...
python -m robocerebra_scripts.robocerebra_eval \
  --model_path "${CKPT}" \
  --case_ids "${CASE_IDS}" \
