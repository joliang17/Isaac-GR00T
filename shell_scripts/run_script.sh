...
python scripts/gr00t_finetune.py --dataset-path /fs/nexus-projects/wilddiffusion/vla/atomic_data/libero_atomic_10/ --num-gpus 1 --batch-size 2 --data_config libero_traj_arms_2 --video_backend torchvision_av --save_steps 200 --output_dir "/fs/nexus-projects/wilddiffusion/vla/GR00T/checkpoint/tt" --dataloader_num_workers=0 --windowing_mode "skill_action" --skill_label_type "skill" --run_name "skillaction_v2_test" --base_model_path "/fs/nexus-projects/wilddiffusion/vla/GR00T/checkpoint/skillaction_v2_stage2/checkpoint-60000"  --skill_annotation_path "/fs/nexus-scratch/yliang17/Research/VLA/AtomicVLA/data_split_json/libero_lerobot_addskill_10.json" --tune_diffusion_model
#  --do_eval
