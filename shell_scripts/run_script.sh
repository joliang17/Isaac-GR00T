...
python scripts/gr00t_finetune.py --dataset-path /fs/nexus-projects/wilddiffusion/vla/LIBERO/traj_skill_only_noid --num-gpus 1 --batch-size 2 --lora_rank 4 --lora_llm_model --window_length=1 --data_config libero_traj_arms_2 --video_backend torchvision_av --save_steps 5 --output_dir "/fs/nexus-projects/wilddiffusion/vla/GR00T/checkpoint/tt" --base_model_path "/fs/nexus-projects/wilddiffusion/vla/GR00T/checkpoint/stage2_onlyembA_nextstep_skip_action_v1_5/checkpoint-6000" --dataloader_num_workers=0 --windowing_mode "sliding_prefix"  --skill_level="step" --run_name "tt_nextstep" 
# --do_eval
...
# python scripts/gr00t_finetune.py --dataset-path /fs/nexus-projects/wilddiffusion/vla/LIBERO/traj_video_both_v2_noid --num-gpus 1 --batch-size 4 --window_length=1 --data_config libero_traj_arms_2 --video_backend torchvision_av --save_steps 20 --output_dir "/fs/nexus-projects/wilddiffusion/vla/GR00T/checkpoint/tt" --base_model_path "/fs/nexus-projects/wilddiffusion/vla/GR00T/checkpoint/stage3_frzembB_nextstep_actiononly_v1/checkpoint-60000" --dataloader_num_workers=0 --windowing_mode "sliding_prefix" --run_name "tt_nextstep"
