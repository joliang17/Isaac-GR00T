...
python scripts/gr00t_finetune.py --dataset-path /fs/nexus-projects/wilddiffusion/vla/LIBERO/traj_skill_only_noid --num-gpus 1 --batch-size 2 --window_length=1 --data_config libero_traj_arms_2 --video_backend torchvision_av --save_steps 10 --output_dir "/fs/nexus-projects/wilddiffusion/vla/GR00T/checkpoint/tt" --base_model_path "/fs/nexus-projects/wilddiffusion/vla/GR00T/checkpoint/stage3_onlyembA_nextstep_actiononly/checkpoint-60000" --dataloader_num_workers=0 --windowing_mode "sliding_prefix"  --skill_level="step" --run_name "tt_nextstep"
