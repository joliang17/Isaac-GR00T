...
python scripts/gr00t_finetune.py --dataset-path /fs/nexus-projects/wilddiffusion/vla/LIBERO/traj_skill_only_noid --num-gpus 1 --batch-size 4 --lora_llm_model --window_length=5 --data_config libero_traj_arms_2 --video_backend torchvision_av --save_steps 20 --output_dir "/fs/nexus-projects/wilddiffusion/vla/GR00T/checkpoint/tt" --base_model_path "/fs/nexus-projects/wilddiffusion/vla/GR00T/checkpoint/stage1_multiview_nextstep_2_merged/checkpoint-5000"
