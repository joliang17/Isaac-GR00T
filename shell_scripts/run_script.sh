...
python scripts/gr00t_finetune.py --dataset-path /fs/nexus-projects/wilddiffusion/vla/LIBERO/traj_video_both_v2_noid --num-gpus 1 --batch-size 4 --window_length=1 --data_config libero_traj_arms_2 --video_backend torchvision_av --save_steps 20 --output_dir "/fs/nexus-projects/wilddiffusion/vla/GR00T/checkpoint/tt" --base_model_path "/fs/nexus-projects/wilddiffusion/vla/GR00T/checkpoint/stage2_onlyembA_nextstep_skip_action_v4/checkpoint-6000" --dataloader_num_workers=0 --windowing_mode "sliding_prefix" --run_name "tt_nextstep"
