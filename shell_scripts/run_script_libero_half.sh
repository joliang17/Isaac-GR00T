...
#SBATCH --job-name=libero_training_half
#SBATCH --output=slurm_output/libero_training_half.log
#SBATCH --error=slurm_output/libero_training_half.log
...
TASK_NAME=libero10_256_half_v2
