...
#SBATCH --job-name=libero_training_half_theother
#SBATCH --output=slurm_output/libero_training_half_theother.log
#SBATCH --error=slurm_output/libero_training_half_theother.log
...
TASK_NAME=libero10_256_half_theother_v2
...
python scripts/gr00t_finetune.py \
  --num-gpus 1 \
  --dataset-path "/fs/nexus-projects/wilddiffusion/vla/atomic_data/libero_atomic_10_half_theother" \
  --windowing_mode "step" \
  --batch-size 32 \
