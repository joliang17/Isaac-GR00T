...
# Exp C (Stage 2 only): FiLM skill conditioning with a learnable no-skill gate.
# The scalar gate multiplies FiLM gamma/beta. gate=0 makes the skill branch an
# identity/no-skill path; gate=1 recovers normal skill FiLM.

#SBATCH --job-name=liberoall_skill_film_gate_s2
#SBATCH --output=slurm_output/liberoall_skill_film_gate_stage2.log
#SBATCH --error=slurm_output/liberoall_skill_film_gate_stage2.log
...
STAGE2_NAME="liberoall_256_full_skill_router_film_gate_stage2"
