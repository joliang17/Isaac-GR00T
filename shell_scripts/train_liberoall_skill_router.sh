...
#SBATCH --job-name=liberoall_skill_router
#SBATCH --output=slurm_output/liberoall_skill_router.log
#SBATCH --error=slurm_output/liberoall_skill_router.log
...
STAGE1_NAME="liberoall_256_full_skill_router_stage1"
STAGE2_NAME="liberoall_256_full_skill_router_stage2"
